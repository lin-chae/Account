...
public class TransactionController {
    ...
    public UseBalance.Response useBalance(
        ...
        try {
            ...
            log.error("Failed ro use balance.");
    ...
    public QueryTransactionRespone queryTransaction(
            @PathVariable String transactionId) {
        return QueryTransactionRespone.from(transactionService.queryTransaction(transactionId));
    }
}